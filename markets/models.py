...
class TradeContract(models.Model):
    ...
    date_end = models.DateField(blank=True, null=True, db_comment='Дата окончания догвора')
    contract_status_type = models.ForeignKey(ContractStatusType, models.DO_NOTHING, db_comment='id статус догвора')
    copy_info = models.CharField(blank=True, null=True, db_comment='Информация о копии догвора')
    copy_files = models.JSONField(blank=True, null=True, db_comment='Файлы догвора')
    active_contract = models.BooleanField(blank=True, null=True, db_comment='Наличие договора аренды')
...
class User(models.Model):
    ...
    fio = models.CharField(max_length=255, blank=True, null=True, db_comment='Фамилия Имя Отество пользователя')
