# Generated by Django 4.2.16 on 2024-11-27 11:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('floor', models.CharField(db_comment='Этаж схемы объекта', default='Не указано')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_num', models.SmallIntegerField(db_comment='Код типа объекта', default=0, unique=True)),
                ('descr', models.TextField(blank=True, db_comment='Описание', null=True)),
            ],
            options={
                'verbose_name': 'Тип ТМ',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking_status_case', models.TextField(db_comment='Причина изменения статуса (например, причина отказа)', default='')),
