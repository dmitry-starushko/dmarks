# Generated by Django 4.2.16 on 2024-09-19 16:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descr', models.TextField(blank=True, db_comment='Опсиание', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('info_contracts_req', models.TextField(blank=True, db_comment='Информация о требованиях для оформления догворов/талонов', null=True)),
                ('info_contracts_req_files', models.JSONField(blank=True, db_comment='Требованиях для оформления догворов/талонов - файлы', null=True)),
                ...
                ('info_constitutive_files', models.JSONField(blank=True, db_comment='Копияи правоустанавливающих документов дочернего предприятия - файлы', null=True)),
                ...
                ('shedule', models.TextField(blank=True, db_comment='График работы', null=True)),
                ...
                ('geo_city', models.ForeignKey(blank=True, db_comment='Город - id', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='markets.locality')),
                ('geo_district', models.ForeignKey(blank=True, db_comment='Район - id', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='markets_geo_district_set', to='markets.locality')),
            ],
            options={
                'db_table': 'markets',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_end', models.DateField(blank=True, db_comment='Дата окончания догвора', null=True)),
                ('copy_info', models.CharField(blank=True, db_comment='Информация о копии догвора', null=True)),
                ('copy_files', models.JSONField(blank=True, db_comment='Файлы догвора', null=True)),
                ...
                ('contract_status_type', models.ForeignKey(db_comment='id статус догвора', on_delete=django.db.models.deletion.DO_NOTHING, to='markets.contractstatustype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fio', models.CharField(blank=True, db_comment='Фамилия Имя Отество пользователя', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_heat_supplay', models.DecimalField(blank=True, db_comment='Оплата услуг теплоснабжения', decimal_places=2, max_digits=12, null=True)),
                ...
                ('location_number', models.CharField(blank=True, db_comment='Номер торгового места', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('market', models.ForeignKey(blank=True, db_comment='id рынка', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='markets.markets')),
            ],
            options={
                'db_table': 'svg_schema',
                'managed': True,
        ...
        migrations.AddField(
            model_name='locality',
            name='locality_type',
            field=models.ForeignKey(blank=True, db_comment='Тип населеного пункта', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='markets.localitytype'),
        ),
        migrations.AddField(
            model_name='locality',
            name='parent',
            field=models.ForeignKey(blank=True, db_comment='Родительская запись. Иерархическое подчинение', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='markets.locality'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street_vending', models.BooleanField(blank=True, db_comment='Возможность выносной торговли', null=True)),
                ('contract_date_start', models.DateField(blank=True, db_comment='Дата начала догвора', null=True)),
                ('contract_date_end', models.DateField(blank=True, db_comment='Дата окончания догвора', null=True)),
                ('contract_copy_info', models.CharField(blank=True, db_comment='Информация о копии догвора', null=True)),
                ...
                ('market', models.ForeignKey(blank=True, db_comment='Уникальный идентификатор рынка', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='markets.markets')),
                ('renter', models.ForeignKey(blank=True, db_comment='id - текущий арендатель', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='markets.renter')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, db_comment='Телефоны', max_length=255, null=True)),
                ('email', models.CharField(blank=True, db_comment='Электронные адреса', max_length=255, null=True)),
                ('shedule', models.CharField(blank=True, db_comment='График работы', null=True)),
                ('ads', models.TextField(blank=True, db_comment='Реклама', null=True)),
                ('market_square', models.FloatField(blank=True, db_comment='Общая площадь рынка', null=True)),
                ('market_count', models.IntegerField(blank=True, db_comment='Кол-во торговых мест', null=True)),
                ('activity', models.TextField(blank=True, db_comment='Возможные виды деятельности', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id_transaction', models.ForeignKey(db_column='user_id_transaction', db_comment='id создателя', on_delete=django.db.models.deletion.DO_NOTHING, to='markets.user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('renter_id', models.DecimalField(blank=True, db_comment='Арендатор', decimal_places=0, max_digits=32, null=True)),
                ('location_number', models.CharField(blank=True, db_comment='Номер торгового места', null=True)),
                ('trade_place', models.ForeignKey(db_comment='Идентификатор торогового места', on_delete=django.db.models.deletion.DO_NOTHING, to='markets.tradeplace')),
                ('user', models.ForeignKey(db_comment='Кто забронировал', on_delete=django.db.models.deletion.DO_NOTHING, to='markets.user')),
            ],
            options={
                'db_table': 'booking',
