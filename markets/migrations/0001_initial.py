# Generated by Django 4.2.16 on 2024-11-24 22:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='renter',
            name='renter_type',
            field=models.ForeignKey(db_comment='Тип арендатора', default=markets.models.RenterType.default_pk, on_delete=django.db.models.deletion.SET_DEFAULT, to='markets.rentertype'),
        ),
        migrations.CreateModel(
            name='MkImage',
            fields=[
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_comment='Тип улицы - id', default=markets.models.StreetType.default_pk, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='markets.streettype'),
        ),
        migrations.AddField(
            model_name='market',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booked_by', models.ForeignKey(blank=True, db_column='ng_user', db_comment='Кто забронировал', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bookings', to=settings.AUTH_USER_MODEL)),
