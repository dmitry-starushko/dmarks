    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booked_by', models.ForeignKey(blank=True, db_column='ng_user', db_comment='Кто забронировал (NULL для старых броней)', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
